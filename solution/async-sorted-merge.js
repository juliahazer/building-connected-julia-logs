...
module.exports = (logSources, printer) => {
  ...
  while (logSources.length > 0) {
    ...
    /******NOTE: I didn't not use Promise.then or Promise.all(iterable) or wait for the Promise to resolve, since I had direct access to LogSource.last - as it was set prior to the creation of the returned Promise */
    curr.popAsync();
